...
PROMPT_TEMPLATE = """
Выступи в роли эксперта-консультанта по продажам, по разработке текстов для объявлений.
...
Весь текст объявления должен быть компактным — не более 400-500 символов и выглядеть как объявление, написанное обычным человеком.
